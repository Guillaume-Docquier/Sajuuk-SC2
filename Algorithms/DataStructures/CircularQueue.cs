...
/// <summary>
/// <para>A textbook implementation of a circular buffer.</para>
/// <para>See https://en.wikipedia.org/wiki/Circular_buffer</para>
/// </summary>
/// <typeparam name="T">The queue elements type.</typeparam>
